...
namespace Analytics
{
    class Tranzakt : ModelingInstrument<Tranzakt>
    {
        ...
        public int my_place;
        //номер строки транзакта в коде или др словами-место, Куда перейдет транзакт при занятом
        //ус-ве добавил обрабтку этого поля только для многоканального ус-ва
        public int sparePlace = 0;
